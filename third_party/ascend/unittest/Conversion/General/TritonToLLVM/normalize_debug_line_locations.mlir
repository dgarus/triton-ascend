// RUN: triton-opt %s -split-input-file --normalize-debug-line-locations --mlir-print-debuginfo | FileCheck %s
...
// CHECK: scf.if
// CHECK: triton.debug_line.class = "control"
...
// CHECK-SAME: triton.debug_line.origin = #[[GLUE_CAST_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: loc(#[[GLUE_SYNTH_LOC:[A-Za-z0-9_]+]])
// CHECK: memref.subview
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[GLUE_SUBVIEW_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: : memref<8xf32> to memref<4xf32, strided<[1], offset: ?>>
// CHECK-SAME: loc(#[[GLUE_SYNTH_LOC]])
// CHECK: scf.if
// CHECK: triton.debug_line.class = "control"
// CHECK-SAME: loc(#[[GLUE_IF_LOC:[A-Za-z0-9_]+]])
// CHECK: return
// CHECK-SAME: triton.debug_line.class = "control"
// CHECK-SAME: loc(#[[GLUE_RETURN_LOC:[A-Za-z0-9_]+]])

// CHECK-DAG: #[[GLUE_CAST_ORIGIN]] = loc("glue.py":2:5)
// CHECK-DAG: #[[GLUE_SUBVIEW_ORIGIN]] = loc("glue.py":3:5)
...
// CHECK-DAG: #[[LOOP_TICKET_LOC]] = loc("ticket"(#[[LOOP_TICKET_FILE_LOC]]))
// CHECK-DAG: #[[LOOP_WRITE_LOC]] = loc("loop_reordering.py":24:33)
// CHECK-DAG: #[[LOOP_NEXT_VALUE_LOC]] = loc("loop_reordering.py":25:35)
...
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[MEMFILL_CONST_ORIGIN:[A-Za-z0-9_]+]]
...
// CHECK-DAG: #[[MEMFILL_CONST_ORIGIN]] = loc("memfill.py":3:5)
...
// CHECK: arith.constant
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[FUTURE_C0_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: 0 : index
// CHECK-SAME: loc(#[[FUTURE_SYNTH_LOC:[A-Za-z0-9_]+]])
// CHECK: arith.constant
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[FUTURE_C1_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: 1 : index
...
// CHECK: arith.addi
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[FUTURE_ADDI_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: : index
// CHECK-SAME: loc(#[[FUTURE_SYNTH_LOC]])

// CHECK-DAG: #[[FUTURE_C0_ORIGIN]] = loc("future.py":8:5)
// CHECK-DAG: #[[FUTURE_C1_ORIGIN]] = loc("future.py":24:5)
// CHECK-DAG: #[[FUTURE_ADDI_ORIGIN]] = loc("future.py":13:5)
...
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[LLVM_CONST_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: loc(#[[LLVM_SYNTH_LOC:[A-Za-z0-9_]+]])
// CHECK: llvm.return
// CHECK-SAME: triton.debug_line.class = "control"
// CHECK-SAME: loc(#[[LLVM_RETURN_LOC:[A-Za-z0-9_]+]])

// CHECK-DAG: #[[LLVM_CONST_ORIGIN]] = loc("llvm.py":20:5)
...
// CHECK: arith.constant
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[NAME_CONST_ORIGIN:[A-Za-z0-9_]+]]
...
// CHECK: arith.constant
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[SCOPE_CONST_ORIGIN:[A-Za-z0-9_]+]]
...
// CHECK-DAG: #[[NAME_CONST_ORIGIN]] = loc("name.py":2:5)
...
// CHECK-DAG: #[[SCOPE_CONST_ORIGIN]] = loc("scope.py":2:5)
...
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[SHAPE_SUBVIEW_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: : memref<8xf32> to memref<4xf32, strided<[1], offset: ?>>
...
// CHECK-SAME: triton.debug_line.class = "synthetic"
// CHECK-SAME: triton.debug_line.origin = #[[SHAPE_CONST_ORIGIN:[A-Za-z0-9_]+]]
// CHECK-SAME: 1 : i32
...
// CHECK: return %[[SHAPE_R]] : i32
// CHECK-SAME: triton.debug_line.class = "control"
// CHECK-SAME: loc(#[[SHAPE_RETURN_LOC:[A-Za-z0-9_]+]])

// CHECK-DAG: #[[SHAPE_SUBVIEW_ORIGIN]] = loc("shape.py":2:5)
// CHECK-DAG: #[[SHAPE_CONST_ORIGIN]] = loc("shape.py":4:5)
